...
```
cd existing_repo
git remote add origin https://gitlab.com/springfield-ham-radio/drivers/radio-module-baofeng.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/springfield-ham-radio/drivers/radio-module-baofeng/-/settings/integrations)
